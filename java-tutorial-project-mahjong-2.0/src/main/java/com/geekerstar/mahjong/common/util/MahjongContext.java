package com.geekerstar.mahjong.common.util;
...
import com.geekerstar.mahjong.common.proto.OperationRequest;
...
public class MahjongContext {
    ...
    public void setPlayerIdChannel(Long playerId, Channel channel) {
        set("playerChannel_" + playerId, channel);
    }

    public Channel getPlayerIdChannel(Long playerId) {
        return get("playerChannel_" + playerId);
    }
