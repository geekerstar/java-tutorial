...
public interface RoomMsgOrBuilder extends
   ...
   */
  java.util.List<com.geekerstar.mahjong.common.proto.PlayerMsg>
      getPlayersList();
  /**
   * <pre>
   **
   ...
   * <code>repeated .PlayerMsg players = 4;</code>
   */
  com.geekerstar.mahjong.common.proto.PlayerMsg getPlayers(int index);
  /**
   * <pre>
   **
   * 房间内的玩家列表
   ...
   * <code>repeated .PlayerMsg players = 4;</code>
   */
  java.util.List<? extends com.geekerstar.mahjong.common.proto.PlayerMsgOrBuilder>
   ...
   * <code>repeated .PlayerMsg players = 4;</code>
   */
  com.geekerstar.mahjong.common.proto.PlayerMsgOrBuilder getPlayersOrBuilder(
      int index);
   ...
   * <code>optional .RoomStatus status = 7;</code>
   */
  com.geekerstar.mahjong.common.proto.RoomStatus getStatus();
}
