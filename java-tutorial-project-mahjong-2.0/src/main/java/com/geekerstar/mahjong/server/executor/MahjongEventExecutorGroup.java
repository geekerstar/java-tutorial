...
import com.geekerstar.mahjong.server.processor.MahjongProcessor;
import com.geekerstar.mahjong.server.processor.MahjongProcessorManager;
    ...
    public static void execute(Channel channel, MahjongProtocol mahjongProtocol) {
        ...
        INSTANCE.execute(() -> {
            ...
            if (currentPlayer != null) {
                ...
                MahjongContext.currentContext().setPlayerIdChannel(currentPlayer.getId(), channel);
            }
            // 寻找处理器
